...
namespace RRF.RRFDbContext.Migrations
{
    ...
    [Migration("20190509115135_Model change and seed again")]
    partial class Modelchangeandseedagain
    {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "1",
                            ConcurrencyStamp = "d5595627-e7bf-43c7-9fb2-cf2a7f0f34a6",
                            Name = "Administrator",
                        ...
                        {
                            Id = "2",
                            ConcurrencyStamp = "f4470ff3-cb5b-458d-9c7f-54938eafc866",
                            Name = "Client",
            ...
            modelBuilder.Entity("RRF.EFModels.Client", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3f235063-8eed-407d-8725-1fb27435286b",
                            ...
                            SecurityStamp = "4fd32f88-a531-4db1-a4d2-46a40d7e8c52",
                            TwoFactorEnabled = false,
                            UserName = "Client"
                        },
                        new
                        {
                            Id = "4bd970d2-acec-4b89-a28f-1fce4470d0cc",
                            APIKey = new Guid("00000000-0000-0000-0000-000000000000"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "ebba9600-40a5-4aab-ae52-d2ea3d599f61",
                            Email = "admin@mail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@MAIL.COM",
                            NormalizedUserName = "ADMIN@MAIL.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEKnfOToMUyhvaH5tiqH6w1GuuvuqFthYUJb38f1UM41pk8XlYH9Efm2s62mzJD9W5g==",
                            PhoneNumber = "+359359",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "b8ae5176-4c72-446f-a52a-49da1af1acf2",
                            TwoFactorEnabled = false,
                            UserName = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("RRF.EFModels.DescendingElement", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2019, 5, 9, 14, 51, 34, 402, DateTimeKind.Local).AddTicks(3211),
                            IsDeleted = false,
                            ModifiedOn = new DateTime(2019, 5, 9, 14, 51, 34, 402, DateTimeKind.Local).AddTicks(4638),
                            Name = "item",
            ...
            modelBuilder.Entity("RRF.EFModels.ModelElement", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2019, 5, 9, 14, 51, 34, 402, DateTimeKind.Local).AddTicks(9623),
                            Description = "<description>",
                            ImageSRC = "<image>",
                            IsDeleted = false,
                            LinkToCurrentElement = "<link>",
                            ModifiedOn = new DateTime(2019, 5, 9, 14, 51, 34, 403, DateTimeKind.Local).AddTicks(1111),
                            PubDate = "<pubDate>",
            ...
            modelBuilder.Entity("RRF.EFModels.RssChannel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2019, 5, 9, 14, 51, 34, 401, DateTimeKind.Local).AddTicks(3160),
                            IsDeleted = false,
                            Name = "testRssChannel",
            ...
            modelBuilder.Entity("RRF.EFModels.RssSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClientId = "baa0d4c2-1589-4378-be1c-238612953ae1",
                            CreatedOn = new DateTime(2019, 5, 9, 14, 51, 34, 401, DateTimeKind.Local).AddTicks(8035),
                            IsDeleted = false,
                            RssChanel_Id = 1
                        });
                });
